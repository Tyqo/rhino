...
class CustomersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->allowEmptyString('equipmentNumber');

        $validator
            ->allowEmptyString('sapNumber');
    ...
    {
        $rules->add($rules->existsIn('salutation_id', 'Salutations'), ['errorField' => 'salutation_id']);
